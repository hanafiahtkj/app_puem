<x-app-layout>
  ...
  <x-slot name="title">DATA BADAN USAHA</x-slot>
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.badan-usaha.getDataTables') }}",
          },
          columns: [
            {data: null},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.badan-usaha.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.badan-usaha.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.badan-usaha.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.badan-usaha.destroy", ":id") }}';
