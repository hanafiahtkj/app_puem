    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.kecamatan.getDataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'nama_kecamatan'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              orderable: false, 
              render: function ( data, type, row ) {
                var url = '{{ route("master.kecamatan.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.kecamatan.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.kecamatan.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.kecamatan.destroy", ":id") }}';
