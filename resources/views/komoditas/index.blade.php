<x-app-layout>
  ...
  <x-slot name="title">DATA KOMODITAS</x-slot>
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.komoditas.getDataTables') }}",
          },
          columns: [
            {data: null},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.komoditas.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.komoditas.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.komoditas.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.komoditas.destroy", ":id") }}';
