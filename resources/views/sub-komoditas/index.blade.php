<x-app-layout>
  ...
  <x-slot name="title">DATA SUB KOMODITAS</x-slot>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.sub-komoditas.getDataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'nama_komoditas'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.sub-komoditas.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.sub-komoditas.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.sub-komoditas.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.sub-komoditas.destroy", ":id") }}';
          url = url.replace(':id', id);
          swal({
