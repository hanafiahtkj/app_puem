<x-app-layout>
  ...
  <x-slot name="title">DATA PERIZINAN</x-slot>
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.perizinan.getDataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'nama_perizinan'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.perizinan.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.perizinan.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.perizinan.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.perizinan.destroy", ":id") }}';
