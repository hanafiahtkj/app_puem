    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="title">Nama Perizinan</label>
          <input type="text" name="nama_perizinan" class="form-control" placeholder="Nama Perizinan..." required>
          <div class="invalid-feedback">Nama Perizinan wajib diisi.</div>
        </div>
        <div class="form-group">
