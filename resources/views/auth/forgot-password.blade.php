      ...
      <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
          <div class="login-brand mb-4">
            <a href="{{ url('') }}">
                <img src="{{ asset('img/SIMPUSDA-removebg.png') }}" alt="logo" width="100">
            </a>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="text-muted">Kami akan mengirimkan tautan ke Email anda untuk mengatur ulang Password</p>
