<x-app-layout>
  ...
  <x-slot name="title">DATA INSTANSI PEMBINA</x-slot>
  ...
  @include('instansi-pembina.modal')
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.instansi-pembina.getDataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'nama_instansi_pembina'},
            {data: 'singkatan'},
            {data: null},
          ],
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.instansi-pembina.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.instansi-pembina.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.instansi-pembina.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.instansi-pembina.destroy", ":id") }}';
