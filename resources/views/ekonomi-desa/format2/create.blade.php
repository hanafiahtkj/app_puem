    ...
    <div class="main-content">
      <section class="section">
        <div class="section-header">
          ...
          <h1>Tambah Data Usaha Jasa</h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dasbor</a></div>
            <div class="breadcrumb-item"><a href="{{ route('ekonomi-desa-format2') }}">Data Data Usaha Jasa</a></div>
            <div class="breadcrumb-item">Tambah Data Usaha Jasa</div>
          </div>
        </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group">
                      <label for="nik">Jenis Usaha</label>
                  ...
                  <div class="form-group">
                    <label for="jenis_kelamin">Jenis produk yang diperdagangkan (Jenis)</label>
