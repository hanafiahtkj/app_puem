<x-app-layout>
  ...
  <x-slot name="title">DATA KATEGORI KOMODITAS</x-slot>
  ...
  @include('kategori-komoditas.modal')
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('master.kategori-komoditas.getDataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'nama_kategori_komoditas'},
            {data: 'format_ekonomi_desa'},
            {data: 'alias'},
            {data: null},
          ],
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("master.kategori-komoditas.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("master.kategori-komoditas.store") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("master.kategori-komoditas.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("master.kategori-komoditas.destroy", ":id") }}';
